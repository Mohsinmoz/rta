...
if (blindmode == 'on') {
	$("#govDubai").attr('src','assets/css/img/bw/govt-of-dubai.png');
	$("#rtaLogo").attr('src','assets/css/img/bw/RTAlogo-white.png');
	$(".view").addClass("active");
	var cssLink = $("<link rel='stylesheet' type='text/css' href='" + getSiteJunction() + 
	"assets/css/blind.css'>");
	$("head").append(cssLink); 
}
